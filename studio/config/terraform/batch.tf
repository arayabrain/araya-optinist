# ============================================================================
# BATCH RESOURCES - COMMENTED OUT
# ============================================================================
# All batch resources have been disabled. To re-enable:
# 1. Uncomment this entire file (remove leading "# " from each line)
# 2. Uncomment batch references in:
#    - monitoring.tf (lines ~247-268)
#    - security.tf (lines ~221-223, ~304-321, ~427-440)
# ============================================================================
