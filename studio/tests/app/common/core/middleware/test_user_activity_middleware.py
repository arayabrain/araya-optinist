...
class TestActivityCacheInvalidation:
    ...
    def test_invalidate_clears_free_cache(self):
        """invalidate_activity_cache should clear free user cache"""
        from studio.app.common.core.middleware.user_activity_middleware import (
            _free_activity_cache,
            _update_cache_after_commit,
    ...
    def test_invalidate_clears_premium_cache(self):
        """invalidate_activity_cache should clear premium cache"""
        from studio.app.common.core.middleware.user_activity_middleware import (
            _premium_activity_cache,
            _update_cache_after_commit,
            invalidate_activity_cache,
    ...
    def test_invalidate_nonexistent_does_not_raise(self):
        """invalidate_activity_cache should not raise for missing user"""
        from studio.app.common.core.middleware.user_activity_middleware import (
            _free_activity_cache,
            _premium_activity_cache,
            invalidate_activity_cache,
    ...
    def test_rapid_relogin_gets_fresh_activity(self):
        """After invalidation, re-login should record fresh activity"""
        from studio.app.common.core.middleware.user_activity_middleware import (
            _free_activity_cache,
            _should_update_activity,
            _update_cache_after_commit,
...
class TestLoggedOutUserTracking:
    """Case 11: Background activity updates for logged out users"""
    ...
    def test_is_logged_out_returns_true_for_recent(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            is_user_logged_out,
            mark_user_logged_out,
        )
    ...
    def test_is_logged_out_returns_false_for_active(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            is_user_logged_out,
        )
    ...
    def test_is_logged_out_returns_false_after_ttl(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
    ...
    @pytest.mark.asyncio
    async def test_free_update_skipped_for_logged_out(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
    ...
    @pytest.mark.asyncio
    async def test_premium_update_skipped_for_logged_out(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
    ...
    def test_free_sync_skipped_for_logged_out(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            _update_free_user_activity_sync,
            mark_user_logged_out,
        )
    ...
    def test_premium_sync_skipped_for_logged_out(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            _update_premium_user_activity_sync,
            mark_user_logged_out,
        )
...
class TestClearFreeUserLoggedOutAt:
    """Case 58/62: Clear logged_out_at on re-login"""
    ...
    def test_clear_returns_true_if_no_assignment(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            clear_free_user_logged_out_at,
        )
    ...
    def test_clear_returns_true_if_already_null(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            clear_free_user_logged_out_at,
        )
    ...
    def test_clear_prevents_cleanup_after_relogin(self):
        from studio.app.common.core.middleware.user_activity_middleware import (
            clear_free_user_logged_out_at,
        )
