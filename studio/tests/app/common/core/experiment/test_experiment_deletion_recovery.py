...
class TestExperimentDeletionRecovery:
    ...
    @pytest.mark.asyncio
    async def test_db_failure_after_s3_deletion_marks_orphaned(self):
        """When DB deletion fails after S3 deletion, experiment should be orphaned"""
        from studio.app.common.core.experiment.experiment_services import (
            ExperimentService,
        )
