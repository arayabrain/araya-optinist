...
| BT-601/602                                  | assignment snackbars                                  | `PremiumNotificationManager.test.tsx` (BT-601 waiting copy + BT-602 success copy) + STO-02 (success snackbar, mocked assignment) + STO-09 (BT-601: the waiting notice persists through a mocked scaling state without an instance announcement); the real AWS-backed flow stays a manual deployed-env check                                                                   |
