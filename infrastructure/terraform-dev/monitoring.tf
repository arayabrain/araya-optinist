...
resource "aws_cloudwatch_log_group" "ecs" {
  name              = "/ecs/development-optinist-cloud-taskdef"
  retention_in_days = 365

  tags = {
    Name = "development-optinist-cloud-logs"
  }
}

resource "aws_cloudwatch_log_group" "premium_ecs" {
  name              = "/ecs/development-premium-optinist-cloud-taskdef"
  retention_in_days = 365

  tags = {
    Name = "development-premium-optinist-cloud-logs"
  }
}

resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  alarm_name          = "development-optinist-cpu-high"
...
resource "aws_cloudwatch_metric_alarm" "memory_high" {
  alarm_name          = "development-optinist-memory-high"
  comparison_operator = "GreaterThanThreshold"
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  alarm_name          = "development-optinist-cpu-low"
...
resource "aws_cloudwatch_metric_alarm" "memory_low" {
  alarm_name          = "development-optinist-memory-low"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = "3"
  metric_name         = "MemoryUtilization"
  namespace           = "AWS/ECS"
...
resource "aws_cloudwatch_metric_alarm" "load_average_high" {
  alarm_name          = "development-optinist-load-average-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  metric_name         = "CPUUtilization"
  namespace           = "AWS/EC2"
...
resource "aws_cloudwatch_metric_alarm" "high_iowait" {
  alarm_name          = "development-optinist-high-iowait"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "rds_cpu_high" {
  alarm_name          = "development-optinist-rds-cpu-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  metric_name         = "CPUUtilization"
  namespace           = "AWS/RDS"
...
resource "aws_cloudwatch_metric_alarm" "rds_connections_high" {
  alarm_name          = "development-optinist-rds-connections-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "rds_storage_low" {
  alarm_name          = "development-optinist-rds-storage-low"
  comparison_operator = "LessThanThreshold"
...
resource "aws_cloudwatch_metric_alarm" "efs_burst_credit_balance" {
  alarm_name          = "development-optinist-efs-burst-credits-low"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = "1"
...
resource "aws_cloudwatch_metric_alarm" "efs_throughput_high" {
  alarm_name          = "development-optinist-efs-throughput-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "alb_5xx_errors" {
  alarm_name          = "development-optinist-alb-5xx-errors"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "alb_response_time_high" {
  alarm_name          = "development-optinist-alb-response-time-high"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_dashboard" "main" {
  dashboard_name = "development-optinist-monitoring"
