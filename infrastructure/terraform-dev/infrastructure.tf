...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "development-optinist-cloud-vpc"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "development-optinist-cloud-igw"
  }
}
...
resource "aws_subnet" "public1" {
  ...
  tags = {
    Name = "development-optinist-cloud-subnet-public1-ap-northeast-1a"
  }
}
...
resource "aws_subnet" "public2" {
  ...
  tags = {
    Name = "development-optinist-cloud-subnet-public2-ap-northeast-1c"
  }
}
...
resource "aws_subnet" "private1" {
  ...
  tags = {
    Name = "development-optinist-cloud-subnet-private1-ap-northeast-1a"
  }
}
...
resource "aws_subnet" "private2" {
  ...
  tags = {
    Name = "development-optinist-cloud-subnet-private2-ap-northeast-1c"
  }
}
...
resource "aws_instance" "nat" {
  ...
  tags = {
    Name = "development-optinist-nat-instance"
  }
}
...
resource "aws_instance" "nat2" {
  ...
  tags = {
    Name = "development-optinist-nat-instance-2"
  }
}
...
resource "aws_eip" "nat_instance" {
  ...
  tags = {
    Name = "development-optinist-nat-instance-eip"
  }
}
...
resource "aws_eip" "nat_instance2" {
  ...
  tags = {
    Name = "development-optinist-nat-instance-2-eip"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "development-optinist-cloud-rtb-public"
  }
}
...
resource "aws_route_table" "private1" {
  ...
  tags = {
    Name = "development-optinist-cloud-rtb-private1-ap-northeast-1a"
  }
}
...
resource "aws_route_table" "private2" {
  ...
  tags = {
    Name = "development-optinist-cloud-rtb-private2-ap-northeast-1c"
  }
}
...
resource "aws_vpc_endpoint" "s3" {
  ...
  tags = {
    Name = "development-optinist-cloud-vpce-s3"
  }
}
...
resource "aws_vpc_endpoint" "ecr_api" {
  ...
  tags = {
    Name = "development-optinist-ecr-api-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "ecr_dkr" {
  ...
  tags = {
    Name = "development-optinist-ecr-dkr-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "logs" {
  ...
  tags = {
    Name = "development-optinist-logs-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "secretsmanager" {
  ...
  tags = {
    Name = "development-optinist-secretsmanager-endpoint"
  }
}
...
resource "aws_s3_bucket" "app_storage" {
  bucket        = "development-optinist-app-storage"
  force_destroy = true

  tags = {
    Name        = "Development OptiNiSt Application Storage"
    Environment = "Test"
  }
}
...
resource "aws_efs_file_system" "snmk" {
  creation_token = "development-optinist-cloud-snmk-volume"
...
resource "aws_efs_access_point" "snmk" {
  ...
  tags = {
    Name = "development-optinist-cloud-efs-ap"
  }
}
...
resource "aws_db_subnet_group" "main" {
  name = "development-optinist-rds-subnet-group"
  subnet_ids = [
...
resource "aws_db_instance" "main" {
  identifier                      = "development-optinist-cloud-rds"
  ...
  tags = {
    Name = "development-optinist-cloud-rds"
  }
}

resource "aws_db_proxy" "main" {
  name          = "development-optinist-rds-proxy"
  engine_family = "MYSQL"
  auth {
    auth_scheme               = "SECRETS"
...
resource "aws_iam_role" "rds_proxy" {
  name = "development-rds-proxy-role"
