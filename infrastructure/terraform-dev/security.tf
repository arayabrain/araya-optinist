...
resource "aws_iam_role" "ecs_task_execution" {
  name = "development-optinist-cloud-task-execution-role"
...
resource "aws_iam_role" "ecs_task" {
  name = "development-optinist-cloud-task-role"
...
resource "aws_iam_role_policy" "ecs_task_efs" {
  name = "development-ecs-task-efs-access"
...
resource "aws_iam_role_policy" "ecs_task_cloudwatch" {
  name = "development-ecs-task-cloudwatch-access"
  role = aws_iam_role.ecs_task.id
...
resource "aws_iam_role_policy" "ecs_task_ecr" {
  name = "development-ecs-task-ecr-access"
  role = aws_iam_role.ecs_task.id
...
resource "aws_iam_role_policy" "ecs_task_ssm_exec" {
  name = "development-ecs-task-ssm-exec"
  role = aws_iam_role.ecs_task.id
...
resource "aws_iam_role" "ecs_instance_role" {
  name = "development-optinist-ecs-instance-role"
...
resource "aws_iam_instance_profile" "ecs_instance_profile" {
  name = "development-optinist-ecs-instance-profile"
  role = aws_iam_role.ecs_instance_role.name
}
...
resource "aws_iam_role_policy" "ecs_instance_enhanced_monitoring" {
  name = "development-ecs-instance-enhanced-monitoring"
...
resource "aws_iam_role_policy" "ecs_instance_ssm_complex" {
  name = "development-ecs-instance-ssm-complex"
  role = aws_iam_role.ecs_instance_role.id
...
resource "aws_iam_role_policy" "ecs_instance_s3_access" {
  name = "development-ecs-instance-s3-access"
  role = aws_iam_role.ecs_instance_role.id
...
resource "aws_iam_role" "nat_instance" {
  name = "development-nat-instance-role"
...
resource "aws_iam_instance_profile" "nat_instance" {
  name = "development-nat-instance-profile"
...
resource "aws_iam_role" "rds_monitoring" {
  name = "development-rds-monitoring-role"
...
resource "aws_iam_role_policy" "ecs_task_execution_cloudwatch" {
  name = "development-cloudwatch-logs"
  role = aws_iam_role.ecs_task_execution.id
...
resource "aws_iam_role_policy" "ecs_instance_detailed_monitoring" {
  name = "development-ecs-instance-detailed-monitoring"
  role = aws_iam_role.ecs_instance_role.id
...
resource "aws_iam_user" "development_optinist_cloud_user" {
  name = "development-optinist-cloud-user"
  path = "/"
}

# IAM Policy for this OptiNiSt Cloud User
resource "aws_iam_policy" "development_optinist_cloud_user_policy" {
  name        = "development-optinist-cloud-user-policy"
...
resource "aws_iam_user_policy_attachment" "development_optinist_cloud_user_policy_attachment" {
  user       = aws_iam_user.development_optinist_cloud_user.name
  policy_arn = aws_iam_policy.development_optinist_cloud_user_policy.arn
}

# Create access key for the user
resource "aws_iam_access_key" "development_optinist_cloud_user_access_key" {
  user = aws_iam_user.development_optinist_cloud_user.name
}

# S3 access for ECS tasks (scoped to app storage bucket)
resource "aws_iam_role_policy" "ecs_task_s3_access" {
  name = "development-ecs-task-s3-access"
  role = aws_iam_role.ecs_task.id
...
resource "aws_iam_role_policy" "ecs_task_lambda_invoke" {
  name = "development-ecs-task-lambda-invoke"
  role = aws_iam_role.ecs_task.id
    ...
    Statement = [
      {
        ...
        Action = "lambda:InvokeFunction"
        Resource = [
          "arn:aws:lambda:${var.aws_region}:${data.aws_caller_identity.current.account_id}:function:development-premium-manager",
          "arn:aws:lambda:${var.aws_region}:${data.aws_caller_identity.current.account_id}:function:development-free-manager"
        ]
      }
    ]
  })
...
resource "aws_iam_role_policy" "ecs_task_routing_secret" {
  name = "development-ecs-task-routing-secret"
  role = aws_iam_role.ecs_task.id
...
resource "aws_iam_role_policy" "ecs_instance_secrets_access" {
  name = "development-ecs-instance-secrets-access"
  role = aws_iam_role.ecs_instance_role.id
...
resource "aws_iam_role_policy" "ecs_task_metadata" {
  name = "development-ecs-task-metadata-access"
  role = aws_iam_role.ecs_task.id
...
resource "aws_security_group" "ecs" {
  name        = "development-ecs-optinist-cloud-security-group"
  description = "Created by Terraform for ECS"
  vpc_id      = aws_vpc.main.id

  tags = {
    Name = "development-optinist-cloud-sg-ecs"
  }
}
...
resource "aws_security_group" "alb" {
  name        = "development-optinist-alb-security-group"
  ...
  tags = {
    Name = "development-optinist-alb-sg"
  }
...
resource "aws_security_group" "rds" {
  name        = "development-optinist-rds-security-group"
  ...
  tags = {
    Name = "development-optinist-cloud-sg-rds"
  }
...
resource "aws_security_group" "efs" {
  name        = "development-optinist-cloud-efs-sg"
...
resource "aws_security_group" "nat_instance" {
  name        = "development-nat-instance-sg"
  ...
  tags = {
    Name = "development-optinist-nat-instance-sg"
  }
}

# Security Group for VPC Endpoints
resource "aws_security_group" "vpc_endpoints" {
  name        = "development-optinist-vpc-endpoints-sg"
...
resource "aws_secretsmanager_secret" "aws_credentials" {
  name        = "development-optinist-cloud-credentials"
...
resource "aws_secretsmanager_secret_version" "aws_credentials" {
  ...
  secret_string = jsonencode({
    AWS_ACCESS_KEY_ID     = aws_iam_access_key.development_optinist_cloud_user_access_key.id
    AWS_SECRET_ACCESS_KEY = aws_iam_access_key.development_optinist_cloud_user_access_key.secret
  })
}

# Store RDS credentials in Secrets Manager
resource "aws_secretsmanager_secret" "rds_credentials" {
  name = "development-rds-credentials"
}
...
resource "aws_secretsmanager_secret" "routing_hmac_key" {
  name        = "development-premium-routing-hmac-key"
...
resource "aws_secretsmanager_secret" "internal_api_secret" {
  name        = "development-internal-api-secret"
...
resource "aws_secretsmanager_secret" "firebase_config" {
  name        = "development-optinist/firebase/config"
...
resource "aws_secretsmanager_secret" "firebase_private_key" {
  name        = "development-optinist/firebase/private-key"
...
resource "aws_secretsmanager_secret" "database_config" {
  name        = "development-optinist/database/config"
...
resource "aws_secretsmanager_secret" "app_config" {
  name        = "development-optinist/app/config"
...
resource "aws_secretsmanager_secret" "stripe_config" {
  name        = "development-optinist/stripe/config"
...
locals {
  key_name = var.key_name != "" ? var.key_name : "development-optinist-cloud-${random_id.key_suffix.hex}"
}

# Generate SSH key pair
resource "tls_private_key" "development_optinist_cloud_key" {
  algorithm = "RSA"
  rsa_bits  = 2048
}

# Create AWS key pair
resource "aws_key_pair" "development_optinist_cloud_key_pair" {
  key_name   = local.key_name
  public_key = tls_private_key.development_optinist_cloud_key.public_key_openssh # Fixed reference

  tags = {
    Name = "development-optinist-cloud-key"
  }
}

# Save private key to local file
resource "local_file" "private_key" {
  content         = tls_private_key.development_optinist_cloud_key.private_key_pem # Fixed reference
  filename        = "${path.module}/development-optinist-cloud-private-key.pem"
