...
**Python version**
Note that version 1 of OptiNiSt used python 3.8, while version 2 uses python 3.9. This difference may cause some errors to occur when upgrading version. Please refer to the [OptiNiSt Wiki FAQ](https://github.com/oist/optinist/wiki) for up-to-date solutions.
...
For responses to common error messages, check the [OptiNiSt Wiki FAQ](https://github.com/oist/optinist/wiki) page, and existing issues on [OptiNiSt git](https://github.com/oist/optinist/wiki). Please create an new issue describing anything not covered on these pages.
